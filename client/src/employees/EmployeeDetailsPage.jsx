                  ...
                  {!payrollLoading && payrollLine ? (
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 12 }}>
                      {[
                        ...
                        { label: 'Unauthorized absent', value: payrollLine.unauthorized_absent_days, accent: '#b91c1c' },
                        ...
                        { label: 'Regular earnings', value: payrollLine.regular_earnings, money: true, accent: '#059669' },
