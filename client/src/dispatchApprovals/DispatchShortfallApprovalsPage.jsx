...
function AdminDispatchShortfallView({ initialStatus = 'pending' }) {
...
export default function DispatchShortfallApprovalsPage() {
  ...
  return (
    <main className="mes-shell">
      <PageHeader
        eyebrow="Shop floor"
        title="Dispatch shortfall approvals"
        subtitle="Approve shipping less than the delivery schedule quantity. Remaining demand stays open."
      />
      <AdminDispatchShortfallView initialStatus={initialStatus} />
    </main>
  );
}
