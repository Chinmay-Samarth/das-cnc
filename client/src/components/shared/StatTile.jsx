export default function StatTile({ label, value, accent, subtext }) {
  return (
    <div style={{ border: '1px solid #e5e7eb', borderLeft: `4px solid ${accent}`, borderRadius: '6px', padding: '24px 20px', background: '#fff' }}>
      ...
      <p className="font-bold" style={{ margin: '4px 0 0', fontSize: '50px', lineHeight: 1, color: '#111827', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, monospace' }}>
        {value}
      </p>
